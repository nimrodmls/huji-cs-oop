...
public class GameManager {
    ...
    public void initializeGame(
        ...
        gameObjects = new GameObjectCollection(windowController.messages());
        ...
        Tools.shelf().registerToolIfAbsent(gameObjects());
        Tools.shelf().registerToolIfAbsent(imageReader);
        Tools.shelf().registerToolIfAbsent(soundReader);
        Tools.shelf().registerToolIfAbsent(windowController);
        Tools.shelf().registerToolIfAbsent(inputListener);
        Tools.shelf().registerToolIfAbsent(windowController.messages());
    }
     ...
     * Cameras are used to render objects not according to their
