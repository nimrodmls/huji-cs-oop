...
public interface WindowController {
    ...
    /**
     * Returns an object responsible for handling logging and messages
     */
    MessageHandler messages();

    /**
     * Open a message box. While the message box is open, the game is paused.
     * @deprecated If you know you want a message-box, prefer
     * {@link MessageHandler#showMessage(String, EnumSet)}, with the call
     * messages().showMessage(msg, OutputMode.MSG_BOX) .
     * More generally, to show a message with a desired level of urgency, use
     * {@link MessageHandler#showMessage(String,MsgLevel)}, for example
     * messages().showMessage(msg, MsgLevel.ERROR) .
     * @see #messages()
     * */
    @Deprecated
    default void showMessageBox(String msg) { messages().showMessage(msg, EnumSet.of(OutputMode.MSG_BOX)); }
